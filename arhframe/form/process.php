...
// if we're performing a file upload
    ...
    function process()
    {
        ...
        // page containing the caller form
            ...
            $server_path = parse_url($_SERVER['HTTP_REFERER']);
        ...
        } elseif (empty($_POST) && empty($_FILES) && isset($_SERVER['CONTENT_LENGTH']) && isset($_SERVER['CONTENT_TYPE']) && strpos($_SERVER['CONTENT_TYPE'], 'multipart/form-data') !== false) {
