...
class Zebra_Form_Control extends XSS_Clean
{
     ...
     *  @access private
     */
    public function Zebra_Form_Control()
    {
     ...
     *  @return void
     */
    public function change_case($case)
    {
     ...
     *  @return void
     */
    public function disable_spam_filter()
    {
     ...
     *  @return void
     */
    public function disable_xss_filters()
    {
     ...
     *  @return void
     */
    public function set_attributes($attributes, $overwrite = true)
    {
     ...
     *  @return void
     */
    public function set_rule($rules)
    {
     ...
     *  @access private
     */
    public function _render_attributes()
    {
