...
class Zebra_Form_Select extends Zebra_Form_Control
{
     ...
     *  @return void
     */
    public function Zebra_Form_Select($id, $default = '', $attributes = '', $default_other = '')
    {
     ...
     *  @return void
     */
    public function add_options($options, $overwrite = false)
    {
     ...
     *  @access private
     */
    public function _generate(&$options, &$selected, $level = 0)
    {
...
//                 var_dump($selected);
//                 print_r('<pre>');
//                 var_dump(!is_array($selected) && $value !== '' && $value == $selected);
//                 print_r('<pre>');
//                 print_r('=============');
