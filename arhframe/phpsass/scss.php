...
class scssc
{
    public static $VERSION = "v0.0.7";

    protected static $operatorNames = array(
        '+' => "add",
        '-' => "sub",
        '*' => "mul",
        '/' => "div",
    ...
    protected static $numberPrecision = 5;
    protected static $unitTable = array(
        "in" => array(
            "in" => 1,
            "pt" => 72,
            "pc" => 6,
    ...
    public static $null = array("null");

    public static $defaultValue = array("keyword", "");
    public static $selfSelector = array("self");
