...
class Eden_Session extends Eden_Class implements ArrayAccess, Iterator
{
    ...
    {
        if (!self::$_session) {
            Eden_Session_Error::i('Session is not started. Try using Eden_Session->start() first.')->trigger();
        }
    ...
    public function get($key = NULL)
    {
        ...
        if (!self::$_session) {
            $error->setMessage("ERROR_ERROR_NOT_STARTED")->trigger();
        }
    ...
    public function set($data, $value = NULL)
    {
        ...
        if (!self::$_session) {
            $error->setMessage('Session is not started. Try using Eden_Session->start() first.')->trigger();
        }
