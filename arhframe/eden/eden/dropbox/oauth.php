 ...
 */
class eden_dropbox_oauth extends Eden_Class
{
    /* Constants
    -------------------------------*/
    const REQUEST_URL 		= 'https://api.dropbox.com/1/oauth/request_token';
    const AUTHORIZE_URL		= 'https://www.dropbox.com/1/oauth/authorize';
    const ACCESS_URL		= 'https://api.dropbox.com/1/oauth/access_token';
